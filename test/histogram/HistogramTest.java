...
public class HistogramTest {
    ...
    @Test
    public void testSmallString() throws InterruptedException {
    ...
    @Test
    public void testAlphabet() throws InterruptedException {
        String charsToCount = "";
        for (char c = 'a'; c <= 'z'; ++c) {
            charsToCount += c;
        }
    ...
    @Test
    public void testAsYouLikeIt() throws FileNotFoundException, InterruptedException {
